...
#End Region
    ...
    Private Sub LIVH(ByVal aform As SAPbouiCOM.Form) 'Load Invoice Header
        Try
            ...
            strqry += " T4.U_Price,T4.RowDiscount,T4.U_TaxCode,T4.U_PaidType,T4.[Type],T4.Qty,T3.U_SequenceType "
                    ...
                    Try
                        ...
                        If intStatus = 0 Then
                            ...
                            If strItemType = "P" Then
                                strqry = " Select Distinct Top " & CInt(dblQty).ToString() & "  T0.DocEntry From DLN1 T0 Where "
