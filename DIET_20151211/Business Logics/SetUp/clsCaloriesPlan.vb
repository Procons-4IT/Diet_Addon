...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Z_OCLP Then
                                    ...
                                    If oForm.Mode <> SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                        If validate() Then
                                            If Not validateData() Then
                                                oApplication.Utilities.Message("Calories Plan Code Already defined...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                                BubbleEvent = False
                                            End If
                                        Else
                                            BubbleEvent = False
                                ...
                                If pVal.ItemUID = "3" And pVal.ColUID <> "U_Code" Then
                                    If pVal.Row = oMatrix.VisualRowCount Then
                                        ...
                                        If strCode.Trim().Length = 0 Then
                                            oApplication.Utilities.Message("Enter Calories Plan Code to Proceed...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                            BubbleEvent = False
                                            Exit Sub
                                        End If
                                    End If
                                ElseIf pVal.ItemUID = "3" And pVal.ColUID = "U_Code" And pVal.Row > 0 Then
                                    If oApplication.Utilities.ValidateRemoveSetup(oApplication.Utilities.getMatrixValues(oMatrix, "U_Code", intMatrixSelectedRow), "CaloriesPlan") = False Then
                                        oApplication.Utilities.Message("Calories Plan : " & oApplication.Utilities.getMatrixValues(oMatrix, "U_Code", intMatrixSelectedRow) & " already mapped to Transaction / Customer.", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
...
#Region "Right Click Event"
    ...
    Public Sub RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean)
        ...
        If oForm.TypeEx = frm_Z_OCLP Then
            ...
            For index As Integer = 1 To oMatrix.VisualRowCount
                ...
                If index = oMatrix.VisualRowCount Then
                    ...
                    If strCode.Trim().Length = 0 And (strName.Trim.Length > 0) Then
                        _retVal = False
                        oApplication.Utilities.Message("Calories Plan Code Cannot be Empty...in Row No :" + index.ToString(), SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        Exit For
                    End If
