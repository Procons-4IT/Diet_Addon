Public Class clsMedical
    ...
    Public Sub LoadForm()
        Try
            If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Z_OMST) = False Then
                oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Exit Sub
            End If
            Dim strUID As String = oApplication.Utilities.LoadForm1(xml_Z_OMST, frm_Z_OMST)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Z_OMST Then
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CLICK
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                oDBDataSource = oForm.DataSources.DBDataSources.Item("@Z_OMST")
                                If pVal.ItemUID = "3" Then
                                    intSelectedMatrixrow = pVal.Row
                                    If (oDBDataSource.GetValue("U_Code", 0).ToString() = "") Then
                                        BubbleEvent = False
                                        oApplication.SBO_Application.SetStatusBarMessage("Enter Medical Code to Proceed...", SAPbouiCOM.BoMessageTime.bmt_Medium, True)
                    ...
                    Case False
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                oDBDataSource = oForm.DataSources.DBDataSources.Item("@Z_OMST")
                                oDBDataSourceLines = oForm.DataSources.DBDataSources.Item("@Z_MST1")
                ...
                Case mnu_Remove
                    ...
                    If pVal.BeforeAction = True Then
                        ...
                        ElseIf oApplication.Utilities.ValidateRemoveSetup(oApplication.Utilities.getEditTextvalue(oForm, "6"), "DisLike") = False Then
                            oApplication.Utilities.Message("Medical Code : " & oApplication.Utilities.getEditTextvalue(oForm, "6") & " already mapped to Transacton / Customer.", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                            BubbleEvent = False
                            Exit Sub
                        End If
                    End If
...
#Region "Right Click Event"
    ...
    Public Sub RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean)
        ...
        If oForm.TypeEx = frm_Z_OMST Then
...
#Region "Function"
    ...
    Private Sub initialize(ByVal oForm As SAPbouiCOM.Form)
        Try
            ...
            oRecordSet.DoQuery("Select IsNull(MAX(DocEntry),0) +1 From [@Z_OMST]")
        ...
        Try
            Select Case aForm.PaneLevel
                Case "0"
                    ...
                    oDBDataSourceLines = aForm.DataSources.DBDataSources.Item("@Z_MST1")
            End Select
            oMatrix.FlushToDataSource()
    ...
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            ...
            If oApplication.Utilities.getEditTextvalue(aForm, "6") = "" Then
                oApplication.Utilities.Message("Enter Medical Code...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            ElseIf oApplication.Utilities.getEditTextvalue(aForm, "7") = "" Then
                oApplication.Utilities.Message("Enter Medical Name...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
            ...
            If Not blnRowExists Then
                oApplication.Utilities.Message("Add Medical Item in Matrix to Proceed...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
            ...
            oRecordSet = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            strQuery = "Select 1 As 'Return',DocEntry From [@Z_OMST]"
            strQuery += " Where "
            strQuery += " U_Code = '" + oDBDataSource.GetValue("U_Code", 0).Trim() + "' And DocEntry <> '" + oDBDataSource.GetValue("DocEntry", 0).ToString() + "'"
            oRecordSet.DoQuery(strQuery)

            If Not oRecordSet.EoF Then
                oApplication.Utilities.Message("Medical Status Code Already Exist...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End If
